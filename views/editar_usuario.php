                ...
                <div class="card-body">
                    <form id="editarUsuarioForm">
                        ...
                        <div class="text-center mt-4">
                            <button type="button" class="btn btn-success btn-lg w-100" id="actualizarDatos"><i class="fas fa-save"></i> Guardar Cambios</button>
                        </div>
                    </form>
                </div>
                
                <div class="card-footer text-center">
                    <a href="inicio" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Volver</a>
                </div>
            </div>
        </div>
    </div>
